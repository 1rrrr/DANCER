...
def _get_conf(conf_name):
    ...
    ###!!!!!
    ## we need to create config file for ncf model
...
def run_dqn():
    ...
    ###!!!!!
    ###this is the input we type in the console window 
    args = set_hparams()
...
###!!!!!
### last line of the console input(--lr 1e-4 --reg 1e-4), what is l2_reg ?????
    ...
    ###!!!!!
    ### modifle here to change the input parameter of the model 

    ###!!!!!
    ### if conf['mode'].lower() == "ncf":
    ###  model = NCF(xxx,xxx,xxx,xxx)
...
###!!!!!
### we need to add ncf evaluator method 
...
###!!!!!
### place where to load config file for different model 
...
###!!!!!
### place where read the string inputed in the console 
def set_hparams():
    import argparse
